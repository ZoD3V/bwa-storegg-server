...
module.exports = {
  ...
  detailPage: async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ msg: "voucher tidak di temukan" || "Terjadi kesalahan" });
    }
  },
  category: async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ msg: "category tidak di temukan" || "Terjadi kesalahan" });
    }
  },
  ...
  historyDetail: async (req, res) => {
    try {
      ...
      if (!history) {
        res.status(404).json({ msg: "History tidak di temukan" });
      }
